...
@Value.Immutable
@ImmutablesStyle
public interface ApproximationResult<N> {
    ImmutableGraph<N> approximation();
    // FIXME(gdennis): a better name for this?
    ImmutableGraph<N> residual();

    static <N> Builder<N> builder() {
        return new Builder<>();
    }

    final class Builder<N> extends ImmutableApproximationResult.Builder<N> {}
}
